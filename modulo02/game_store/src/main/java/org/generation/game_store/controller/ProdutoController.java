...
public class ProdutoController {
		...
		public ResponseEntity<List<ProdutoModel>> getByName (@PathVariable String nameProd) {
			return ResponseEntity.ok(repository.findAllByNameProdContainingIgnoreCase(nameProd));
		}
